<script lang="ts">
    ...
    let tagFilterRef: TagFilterPanel | undefined = $state(undefined);
...
let filteredPatterns = $derived($patterns
  .filter(p => {
            ...
            >
              <div class="flex justify-between items-start mb-2">
                ...
                <span
                  ...
                  onkeydown={(e: KeyboardEvent) => (e.key === "Enter" || e.key === " ") && toggleFavorite(pattern.Name)}
  ...
  {#if isTagPanelOpen}
    <div class="tag-panel-container">
      <div class="tag-panel-header">
        <button class="tag-panel-close" onclick={toggleTagPanel}>
